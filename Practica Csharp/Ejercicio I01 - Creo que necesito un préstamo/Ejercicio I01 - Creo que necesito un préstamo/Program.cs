...
Cuenta cuenta = new Cuenta("Empresa XYZ", 1000);

Console.WriteLine("Estado inicial de la cuenta:");
Console.WriteLine(Cuenta.Mostrar(cuenta));

cuenta.Ingresar(500);
Console.WriteLine("Después de depositar 500:");
Console.WriteLine(Cuenta.Mostrar(cuenta));
...
cuenta.Retirar(1500);
Console.WriteLine("Después de intentar retirar 1500:");
Console.WriteLine(Cuenta.Mostrar(cuenta));
