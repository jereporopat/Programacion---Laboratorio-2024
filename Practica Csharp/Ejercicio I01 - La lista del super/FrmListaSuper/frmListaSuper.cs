...
namespace FrmListaSuper
{
    public partial class frmListaSuper : Form
    {
        ...
        {
            frmAltasMod frmAltaModificacion = new frmAltasMod("Agregar objeto", string.Empty, "Agregar");
        ...
        private void ModificarElemento()
        {
            ...
            {
                frmAltasMod frmAltaModificacion = new frmAltasMod("Modificar objeto", objetoSeleccionado, "Agregar");
                frmAltaModificacion.ShowDialog();
